...
import { generateKeyPair, deriveSharedSecret, encryptMessage } from "@/utils/x25519-cipher";
...
const Virtualization = () => {
  ...
  const visualizeEncryption = async () => {
    ...
    const { ciphertext: fullCiphertext } = encryptMessage(inputText, sharedSecret);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        <div className="text-center mb-8 sm:mb-12 animate-fade-in">
          ...
          <p className="text-base sm:text-xl text-muted-foreground max-w-2xl mx-auto">
            Visualize how X25519 encryption transforms each character step by step
          </p>
        </div>

        <Card className="p-6 sm:p-8 glass-card mb-8 animate-fade-in" style={{ animationDelay: "0.1s" }}>
